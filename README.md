...
Maxl0x -t <TARGET> -o -re

[*] STEALTH MODE + OSINT + RECON
Maxl0x -t <TARGET> -m stealth -o -re

[*] DISCOVER MODE
Maxl0x -t <CIDR> -m discover -w <WORSPACE_ALIAS>

[*] SCAN ONLY SPECIFIC PORT
Maxl0x -t <TARGET> -m port -p <portnum>

[*] FULLPORTONLY SCAN MODE
Maxl0x -t <TARGET> -fp

[*] WEB MODE - PORT 80 + 443 ONLY!
Maxl0x -t <TARGET> -m web

[*] HTTP WEB PORT MODE
Maxl0x -t <TARGET> -m webporthttp -p <port>

[*] HTTPS WEB PORT MODE
Maxl0x -t <TARGET> -m webporthttps -p <port>

[*] HTTP WEBSCAN MODE
Maxl0x -t <TARGET> -m webscan 

[*] ENABLE BRUTEFORCE
Maxl0x -t <TARGET> -b

[*] AIRSTRIKE MODE
Maxl0x -f targets.txt -m airstrike

[*] NUKE MODE WITH TARGET LIST, BRUTEFORCE ENABLED, FULLPORTSCAN ENABLED, OSINT ENABLED, RECON ENABLED, WORKSPACE & LOOT ENABLED
Maxl0x -f targets.txt -m nuke -w <WORKSPACE_ALIAS>

[*] MASS PORT SCAN MODE
Maxl0x -f targets.txt -m massportscan

[*] MASS WEB SCAN MODE
Maxl0x -f targets.txt -m massweb

[*] MASS WEBSCAN SCAN MODE
Maxl0x -f targets.txt -m masswebscan

[*] MASS VULN SCAN MODE
Maxl0x -f targets.txt -m massvulnscan

[*] PORT SCAN MODE
Maxl0x -t <TARGET> -m port -p <PORT_NUM>

[*] LIST WORKSPACES
Maxl0x --list

[*] DELETE WORKSPACE
Maxl0x -w <WORKSPACE_ALIAS> -d

[*] DELETE HOST FROM WORKSPACE
Maxl0x -w <WORKSPACE_ALIAS> -t <TARGET> -dh

[*] GET Maxl0x SCAN STATUS
Maxl0x --status

[*] LOOT REIMPORT FUNCTION
Maxl0x -w <WORKSPACE_ALIAS> --reimport

[*] LOOT REIMPORTALL FUNCTION
Maxl0x -w <WORKSPACE_ALIAS> --reimportall

[*] LOOT REIMPORT FUNCTION
Maxl0x -w <WORKSPACE_ALIAS> --reload

[*] LOOT EXPORT FUNCTION
Maxl0x -w <WORKSPACE_ALIAS> --export

[*] SCHEDULED SCANS
Maxl0x -w <WORKSPACE_ALIAS> -s daily|weekly|monthly

[*] USE A CUSTOM CONFIG
Maxl0x -c /path/to/Maxl0x.conf -t <TARGET> -w <WORKSPACE_ALIAS>
...
* **NUKE:** Launch full audit of multiple hosts specified in text file of choice. Usage example: ./Maxl0x /pentest/loot/targets.txt nuke.
* **DISCOVER:** Parses all hosts on a subnet/CIDR (ie. 192.168.0.0/16) and initiates a Maxl0x scan against each host. Useful for internal network scans.
