...
LOOT_DIR=/usr/share/Maxl0x/loot
PLUGINS_DIR=/usr/share/Maxl0x/plugins
GO_DIR=~/go/bin
...
chown root $INSTALL_DIR/Maxl0x 2> /dev/null
...
rm -f /usr/share/Maxl0x/templates/active/CVE*
...
wget https://raw.githubusercontent.com/janmasarik/resolvers/master/resolvers.txt -O /usr/share/Maxl0x/wordlists/resolvers.txt
...
chmod +x $INSTALL_DIR/Maxl0x
chmod +x $PLUGINS_DIR/Goohak/goohak
rm -f /usr/bin/dirsearch
ln -s $INSTALL_DIR/Maxl0x /usr/bin/Maxl0x 2> /dev/null
...
ln -s /usr/share/Maxl0x /Maxl0x 2> /dev/null
ln -s /usr/share/Maxl0x /usr/share/sn1per 2> /dev/null
ln -s /usr/share/Maxl0x/loot/workspace /workspace 2> /dev/null
ln -s /usr/share/Maxl0x/loot/workspace /root/workspace 2> /dev/null
ln -s /usr/share/Maxl0x /root/Maxl0x 2> /dev/null
ln -s /root/.Maxl0x.conf /usr/share/Maxl0x/conf/Maxl0x.conf 2> /dev/null
ln -s /root/.Maxl0x_api_keys.conf /usr/share/Maxl0x/conf/Maxl0x_api_keys.conf 2> /dev/null
mv /root/.Maxl0x.conf /root/.Maxl0x.conf.bak 2> /dev/null
cp -vf /usr/share/Maxl0x/Maxl0x.conf /root/.Maxl0x.conf 2> /dev/null
...
mkdir -p /usr/share/Maxl0x/loot/workspaces/ 2> /dev/null
ln -fs /usr/share/Maxl0x/loot/workspaces/ /home/kali/Desktop/workspaces 2> /dev/null
ln -fs /usr/share/Maxl0x/loot/workspaces/ /root/Desktop/workspaces 2> /dev/null

echo -e "$OKRED[>]$RESET Done! $RESET"
echo -e "$OKRED[>]$RESET To run, type 'Maxl0x'! $RESET"
